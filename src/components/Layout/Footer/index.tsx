    ...
    <footer className="bg-deepSlate py-10">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className='col-span-4 md:col-span-4 lg:col-span-4'>
            <div className="flex items-center gap-2">
              ...
              />
              <h5 className="text-lg text-black/60">joyz*</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Icon
                ...
                className="text-primary text-3xl inline-block me-2"
              />
              <h5 className="text-lg text-black/60">+45 0000 00</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Icon
                icon="tabler:folder"
        ...
        <div className='mt-10 lg:flex items-center justify-between'>
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>@2025 joyz*. All Rights Reserved by <Link href="/" className="hover:text-primary"> joyz*</Link></h4>
